...
public class ArrayDemo1 {
	...
	public static void main(String[] args) {
		 ...
		 *  배열의 생성
		 *   - 정수 5개를 저장할는 배열 생성해서 참조변수에 담기
		 *  	int[] numbers = new int[5];
		 *  		생성된 배열 => [0, 0, 0, 0, 0]
		 *  	int[] numbers = {10, 40, 20, 60, 40};	// 배열 리터럴
		 *  		생성된 배열 => [10, 40, 20, 60, 40]
		 *  	int[] numbers = new int[]{10, 20, 30, 40, 50};
		 *  		생성된 배열 => [10, 20, 30, 40, 50]
		 *  
		 *   - 배열을 생성할 때 배열의 길이만 지정해서 배열을 생성하면 배열의 각 요소에는 해당 데이터 타입
		 *   의 기본값으로 초기화되어 있다.
		 *   	* 데이터타입별 기본값
		...
		System.out.println("0번째 정수: " + number1[0]);
		System.out.println("1번째 정수: " + number1[1]);
		System.out.println("2번째 정수: " + number1[2]);
		
		// 실수형 배열
		double[] number2 = new double[3];
		System.out.println("0번째 실수: " + number2[0]);
		System.out.println("1번째 실수: " + number2[1]);
		System.out.println("2번째 실수: " + number2[2]);

...
public class OpDemo6 {
	...
	public static void main(String[] args) {
		...
		// 문자열 리터럴을 이용해서 String객체를 생성하게 되면 동일한 문자열인 경우 새로 객체를
		// 만들지 않고 기존 객체를 같이 사용한다. 즉, str1 과 str2가 참조하는 객체는 동일한 객체다.
		...
		// new 키워드를 이용해서 String객체를 생성하게 되면 일반적인 객체들처럼 매번 새로운 객체가 생성하고
		// 참조하게 된다. 즉, str3와 str4가 참조하는 객체는 서로 다른 객체다.
		...
		// equals() 메소드는 String객체의 생성방식과 상관없이 문자열의 내용을 비교하기 때문에 문자열의

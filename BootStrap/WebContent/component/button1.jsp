	...
	<div class="row">
		<div class="col-12">
			...
			<div>
				...
				<button type="button" class="btn btn-primary">Nomarl Button</button>
			...
			<div>
				<a href="#" class="btn btn-primary">링크</a>
				<a href="#" class="btn btn-primary active">링크</a>
				<button type="button" class="btn btn-primary">버튼</button>

				<a href="#" class="btn btn-primary disabled">링크</a>
				<button type="button" class="btn btn-primary disabled">버튼</button>
			</div>

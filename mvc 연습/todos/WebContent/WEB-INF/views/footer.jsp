<%@ page language="java" pageEncoding="UTF-8"%>
		...
		<div class="modal-dialog">
			<form method="post" action="login.hta">
	 			<div class="modal-content">
	   				...
	   				<div class="modal-footer">
	     				<button type="button" class="btn btn-outline-success btn-sm" onclick="loginCheck()">로그인</button>
	     				<button type="button" class="btn btn-outline-dark btn-sm" data-dismiss="modal">닫기</button>
	   				</div>
	 			</div>
 			</form>
	...
	<script type="text/javascript">
		...
		function loginCheck() {
			var userName = document.querySelector("input[name=userid]").value;
			var userPwd = document.querySelector("input[name=userpwd]").value;
			var data = "userid=" + userName + "&userpwd=" + userPwd;

	...
	<div class="row mb-3">
		<div class="col-12">
			<div class="card">
				...
				<div class="card-body">
					<form method="get" action="/todo/list.hta" id="list-form">
						...
						<div class="row">
							<div class="col-6 ">
								<ul class="pagination">
									<li class="page-item"><a class="page-link" href="#" onclick="refreshList()">이전</a></li>
									<c:forEach begin="${pagination.begin }" end="${pagination.end }" var="num">
										<li class="page-item"><a class="page-link" href="#" onclick="refreshList(${num}, event)">${num }</a></li>									
									</c:forEach>
									<li class="page-item"><a class="page-link" href="#" onclick="refreshList()">다음</a></li>
								</ul>
							</div>

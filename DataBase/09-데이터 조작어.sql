...
values
('young', 'zxcv1234', '주영', 'juyoung@naver.com', 10, sysdate);
...
insert into sample_book_users
values
('ssosso', 'zxcv1234', '소영', 'ssosso@gmail.com'); -- 오류, 값이 부족함.
...
values
('dalchong', 'zxcv1234', '김수한무거북이와두리미삼천갑자동박삭김수한무거북이와두리미삼천갑자동박삭김수한무거북이와두리미삼천갑자동박삭');
...
-- 서브쿼리를 이용해서 값 변경하기
-- 최소 급여를 받는 직원의 급여를 해당 부서의 평균급여로 변경하기
-- 최소 급여를 받는 직원
...
set
    department_id = 500
where employee_id = 100;    -- 오류, 부모테이블(departments)에 500번 부서가 존재하지 않음1

-- 데이터 삭제하기
-- 아이디가 suyoung인 행 삭제하기
...
insert into sample_book_users
values('kkang', 'zxcv1234', '강감찬', 'kkang@gmail.com', 10, sysdate);
